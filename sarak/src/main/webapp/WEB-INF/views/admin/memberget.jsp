  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <label>회원 비밀번호</label> <input class="form-control" name='mpw'
            value='<c:out value="${member.mpw }"/>' readonly="readonly">
        </div>
        
        <div class="form-group">
          <label>회원 이름</label> <input class="form-control" name='mname'
            value='<c:out value="${member.mname }"/>' readonly="readonly">
        </div>
        
        <div class="form-group">
          <label>회원 전화번호</label> <input class="form-control" name='phone'
            value='<c:out value="${member.phone }"/>' readonly="readonly">
        </div>
        
        <div class="form-group">
          <label>회원 이메일</label> <input class="form-control" name='email'
            value='<c:out value="${member.email }"/>' readonly="readonly">
        </div>
        
        <div class="form-group">
          <label>회원 우편번호</label> <input class="form-control" name='postcode'
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" rows="3" name='address'
       	...
       	<div class="form-group">
          <label>회원 가입일</label> 
			<input class="form-control" name='mregdate'
