	    ...
	    <div class="mypage_content_wrap">
	       ...
	       <div class="profile-wrap">
		      ...
		      <div class="profile-input">
		      		<input class="profile-form-control" name='mid'
		            value='<c:out value="${member.mid }"/>' readonly="readonly">
		            		
		         	<input class="profile-form-control" name='mpw'
		            value='*******' readonly="readonly">
		            
		          	<input class="profile-form-control" name='mname'
		            value='<c:out value="${member.mname }"/>' readonly="readonly">
		            
		           	<input class="profile-form-control" name='phone'
		            value='<c:out value="${member.phone }"/>' readonly="readonly">
		            
		           	<input class="profile-form-control" name='email'
		            value='<c:out value="${member.email }"/>' readonly="readonly">
		            
		           	<input class="profile-form-control" name='postcode'
		            value='<c:out value="${member.postcode }"/>' readonly="readonly">
		            
		        	<textarea class="profile-form-control" rows="3" name='address'
		            readonly="readonly"><c:out value="${member.address}" /></textarea>
					
					<input class="profile-form-control" name='mregdate'
					        value='<fmt:formatDate pattern="yyyy-MM-dd" value="${member.mregdate}" />' readonly="readonly">
		      </div>
